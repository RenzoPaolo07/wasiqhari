@forelse($adultos as $adulto)
    <tr id="fila-adulto-{{ $adulto->id }}">
        ...
        <td>
            <button class="btn-action btn-ver" data-id="{{ $adulto->id }}" title="Ver / Editar">
                <i class="fas fa-eye"></i>
            </button>
            <button class="btn-action btn-eliminar" data-id="{{ $adulto->id }}" data-name="{{ $adulto->nombres }} {{ $adulto->apellidos }}" title="Eliminar">
...
<tr style="display:none;">
    <td colspan="7" id="pagination-links">
        {{ $adultos->links() }}
    </td>
</tr>